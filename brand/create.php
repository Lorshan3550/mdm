...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($code) || empty($name)) {
        ...
        $sql = "INSERT INTO master_brands (user_id, code, name, status) 
                VALUES ('$user_id', '$code', '$name', '$status')";
        if (mysqli_query($conn, $sql)) {
            header("Location: index.php");
            exit();
        } else {
            $error = "Failed to create brand: " . mysqli_error($conn);
        }
    }
}
?>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="create.php">
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" id="code" class="form-control" placeholder="Enter brand code" required>
                    </div>
                    <div class="mb-3">
